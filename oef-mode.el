...
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["affine" (lambda () (interactive) (insert "affine ")) :help "affine a,b,c,d,tx,ty\n\ndefines a transformation matrix for subsequent objects\nimages drawn by setting skew params a & d will be very different from Flydraw's \"affine a,b,c,d,e,tx,ty\" !!\nuse keyword 'killaffine' to end the transformation\nnote 1: only 'draggable' / 'noclick' objects can be transformed.\nnote 2: do not use 'onclick' or 'drag xy' with tranformation objects : the mouse coordinates do not get transformed (yet)\nnote 3: no matrix operations on the transformation matrix implemented (yet)\na : Scales the drawings horizontally\nb : Skews the drawings horizontally\nc : Skews the drawings vertically\nd : Scales the drawings vertically\ntx: Moves the drawings horizontally in xrange coordinate system\nty: Moves the drawings vertically in yrange coordinate system\nthe data precision may be set by preceding command \"precision int\""])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["angle" (lambda () (interactive) (insert "angle ")) :help "angle xc,yc,width,start_angle,end_angle,color\n\nwidth is in x-range\nwill zoom in/out\nif size is controlled by command 'slider' use radians to set limits of slider."])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["animate" (lambda () (interactive) (insert "animate ")) :help "animate type\n\nREMOVED : this should be done with a slider\ntype may be \"point\" (nothing else , yet...)\nthe point is a filled rectangle ; adjust colour with command 'fillcolor colorname/hexnumber'\nwill animate a point on the next plot/curve command\nthe curve will not be draw\nmoves repeatedly from xmin to xmax"])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["arc" (lambda () (interactive) (insert "arc ")) :help "arc xc,yc,width,height,start_angle,end_angle,color\n\ncan not be set \"onclick\" or \"drag xy\"\nattention: width in height in x/y-range\nwill not zoom in or zoom out (because radius is given in pixels an not in x/y-system !). Panning will work\nuse command 'angle' for scalable angle"])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["arrow" (lambda () (interactive) (insert "arrow ")) :help "arrow x1,y1,x2,y2,h,color\n\nalternative command:vector\ndraw a single headed arrow / vector from (x1:y1) to (x2:y2)\nwith arrowhead size h in px and in color 'color'\nuse command 'linewidth int' to adjust thickness of the arrow\nmay be set draggable / onclick"])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["arrow2" (lambda () (interactive) (insert "arrow2 ")) :help "arrow2 x1,y1,x2,y2,h,color\n\ndraw a double headed arrow/vector from (x1:y1) to (x2:y2)\nwith arrowhead size h in px and in color 'color'\nuse command 'arrowhead int' to adjust the arrow head size\nuse command 'linewidth int' to adjust thickness of the arrow\nmay be set draggable / onclick"])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["arrowhead" (lambda () (interactive) (insert "arrowhead ")) :help "arrowhead int\n\ndefault 8 (pixels)"])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["arrows" (lambda () (interactive) (insert "arrows ")) :help "arrows color,head (px),x1,y1,x2,y2...x_n,y_n\n\nalternative command:vectors\ndraw single headed arrows / vectors from (x1:y1) to (x2:y2) ... (x3:y3) to (x4:y4) etc ... in color 'color'\nuse command 'linewidth int' to adjust thickness of the arrow\nmay be set draggable / onclick individually"])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["arrows2" (lambda () (interactive) (insert "arrows2 ")) :help "arrows2 color,head (px),x1,y1,x2,y2...x_n,y_n\n\ndraw double headed arrows / vectors from (x1:y1) to (x2:y2) ... (x3:y3) to (x4:y4) etc ... in color 'color'\nuse command 'linewidth int' to adjust thickness of the arrows\nmay be set draggable / onclick individually"])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["audio" (lambda () (interactive) (insert "audio ")) :help "audio x,y,w,h,loop,visible,audiofile location\n\nx,y : left top corner of audio element (in xrange / yrange)\nw,y : width and height in pixels\nloop : 0 or 1 ( 1 = loop audio fragment)\nvisible : 0 or 1 (1 = show controls)\naudio format may be in *.mp3 or *.ogg\nIf you are using *.mp3 : be aware that FireFox will not (never) play this ! (Pattented format)\nif you are using *.ogg : be aware that Microsoft based systems not support it natively\nTo avoid problems supply both types (mp3 and ogg) of audiofiles.\nthe program will use both as source tag\nexample: upload both audio1.ogg and audio1.mp3 to http://server/files/\naudio 0,0,http://server/files/audio1.mp3\nsvdraw will copy html-tag audio1.mp3 to audio1.ogg\nand the browser will play the compatible file (audio1.ogg or audio1.mp3)"])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["axis" (lambda () (interactive) (insert "axis ")) :help "axis\n\nkeyword (no arguments required)\nto be used before command grid (see command grid)"])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["axisnumbering" (lambda () (interactive) (insert "axisnumbering ")) :help "axisnumbering\n\nkeyword (no arguments required)\nfor special numbering of x-axis or y-axis see grid related commands axis xaxis , xaxisup, noxaxis ,yaxis , yaxisup, noyaxis\nto be used before command grid (see command grid)"])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["barchart" (lambda () (interactive) (insert "barchart ")) :help "barchart x_1:y_1:color_1:x_2:y_2:color_2:...x_n:y_n:color_n\n\nmay only to be used together with command 'grid'\ncan be used together with freestyle x-axis/y-axis texts : see commands 'xaxis','xaxisup' and 'yaxis'\nuse command 'legend' to provide an optional legend in right-top-corner\nmultiple barchart command may be used in a single script\nalso see command 'piechart'\nnote: your arguments are not checked by canvasdraw : use your javascript console in case of trouble..."])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["bezier" (lambda () (interactive) (insert "bezier ")) :help "bezier color,x_start,y_start,x_first,y_first,x_second,y_second,x_end,y_end\n\ndraw a bezier curve between points, starting from (x_start:y_start)\ncan not be dragged or set onclick"])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["bgcolor" (lambda () (interactive) (insert "bgcolor ")) :help "bgcolor colorname or #hex\n\nuse this color as background of the "div" containing the canvas(es)"])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["bgimage" (lambda () (interactive) (insert "bgimage ")) :help "bgimage image_location\n\nuse an image as background .\ntechnical: we use the background of 'canvas_div'\nthe background image will be resized to match \"width = xsize\" and \"height = ysize\""])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["blink" (lambda () (interactive) (insert "blink ")) :help "blink time(seconds)\n\nNOT IMPLEMETED -YET"])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["boxplot" (lambda () (interactive) (insert "boxplot ")) :help "boxplot x_or_y,box-height_or_box-width,position,min,Q1,median,Q3,max\n\nexample:\nxrange 0,300\nyrange 0,10\nboxplot x,4,8,120,160,170,220,245\nmeaning: create a boxplot in x-direction, with height 4 (in yrange) and centered around line y=8\nexample:\nxrange 0,10\nyrange 0,300\nboxplot y,4,8,120,160,170,220,245\nmeaning: create a boxplot in y-direction, with width 4 (in xrange) and centered around line x=8\nuse command 'filled' to fill the box\nnote: the strokecolor is used for filling Q1, the fillcolor is used for filling Q3\nuse command 'opacity' to adjust fill_opacity of stroke and fill colours\nuse command 'legend' to automatically create a legend\nunicode allowed in legend\nuse command 'fontfamily' to set the font of the legend.\nthere is no limit to the number of boxplots used.\ncan not be set draggable ('onclick' is not ready ,yet)\nuse keyword 'userboxplot' before command boxplot, if a pupil must draw a boxplot (using his own min,Q1,median,Q3,max data)\nuse keyword 'userboxplotdata' before command boxplot, if a pupil must generate the data by some means.\nuse command 'boxplotdata' when the boxplot should be drawn from wims-generated raw statistical date"])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["boxplotdata" (lambda () (interactive) (insert "boxplotdata ")) :help "boxplotdata some_data\n\n'some_data' are a list of numbers separated by a comma \",\" (items)\nonly be used before command 'boxplot': the command 'boxplot' will provide the boxplot drawing of the data.\nxrange 0,100\nyrange 0,10\nboxplotdata 11,22,13,15,23,43,12,12,14,2,45,32,44,13,21,24,13,19,35,21,24,23\nboxplot x,4,5\nnote: wims will not check your data input | format. use js-error console to debug any problems.\na javascript function 'statistics()' will parse the data and calculate the values [min,Q1,median,Q3,max] and hand them to the boxplot draw\nfunction."])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["\\canvasdraw" (lambda () (interactive) (insert "\\canvasdraw{«width»,«height»}{\\mydraw} ")) :help "First you have to define a text variable (i.e. \\mydraw) containing the drawing code"])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["canvastype" (lambda () (interactive) (insert "canvastype ")) :help "canvastype TYPE\n\nfor now only usefull before commands filltoborder / floodfill / clickfill etc operations\nOnly the images of this TYPE will be scanned and filled\ndefault value of TYPE is DRAG_CANVAS e.g. 5\nuse another TYPE if you know what you are doing...\nother possible canvasses (transparent PNG pictures xsize x ysize on top of eachother)\nEXTERNAL_IMAGE_CANVAS = 0\nBG_CANVAS = 1\nSTATIC_CANVAS = 2\nMOUSE_CANVAS = 3 : used for command \"mouse\"\nGRID_CANVAS = 4 :used for command \"grid\"\nDRAG_CANVAS = 5 :default\nDRAW_CANVAS = 6 :used for some static drawings\nTEXT_CANVAS = 7 : used for text-strings\nCLOCK_CANVAS = 8 : used for command \"clock\"\nANIMATE_CANVAS = 9 : not used for now\nTRACE_CANVAS = 10 : used for command \"trace_jscurve\"\nJSPLOT_CANVAS = 111 : will be increased with every new command \"jscurve\"\nFILL_CANVAS = 12 : this will be filled...so do not use !\nUSERDRAW_JSPLOT 13 : will be increased with every new command \"userinput function\""])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["centerstring" (lambda () (interactive) (insert "centerstring ")) :help "centerstring color,y-value,the text string\n\ntitle color,y-value,the text string\ndraw a string centered on the canvas at y = y-value\ncan not be set \"onclick\" or \"drag xy\" (...)\nunicode supported: centerstring red,5,\\u2232\nuse a command like 'fontfamily italic 24px Ariel'\nto set fonts on browser that support font change"])

(easy-menu-add-item oef-menu-bar '("Canvasdraw")["blink" (lambda () (interactive) (insert "blink ")) :help "Sorry. There is no help for blink "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["circle" (lambda () (interactive) (insert "circle ")) :help "Sorry. There is no help for circle "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["circles" (lambda () (interactive) (insert "circles ")) :help "Sorry. There is no help for circles "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["clearbutton" (lambda () (interactive) (insert "clearbutton ")) :help "Sorry. There is no help for clearbutton "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["clock" (lambda () (interactive) (insert "clock ")) :help "Sorry. There is no help for clock "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["copy" (lambda () (interactive) (insert "copy ")) :help "Sorry. There is no help for copy "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["copyresized" (lambda () (interactive) (insert "copyresized ")) :help "Sorry. There is no help for copyresized "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["crosshair" (lambda () (interactive) (insert "crosshair ")) :help "Sorry. There is no help for crosshair "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["crosshairs" (lambda () (interactive) (insert "crosshairs ")) :help "Sorry. There is no help for crosshairs "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["crosshairsize" (lambda () (interactive) (insert "crosshairsize ")) :help "Sorry. There is no help for crosshairsize "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["cursor" (lambda () (interactive) (insert "cursor ")) :help "Sorry. There is no help for cursor "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["curve" (lambda () (interactive) (insert "curve ")) :help "Sorry. There is no help for curve "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["dashed" (lambda () (interactive) (insert "dashed ")) :help "Sorry. There is no help for dashed "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["dashtype" (lambda () (interactive) (insert "dashtype ")) :help "Sorry. There is no help for dashtype "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["delete" (lambda () (interactive) (insert "delete ")) :help "Sorry. There is no help for delete "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["demiline" (lambda () (interactive) (insert "demiline ")) :help "Sorry. There is no help for demiline "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["demilines" (lambda () (interactive) (insert "demilines ")) :help "Sorry. There is no help for demilines "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["diamondfill" (lambda () (interactive) (insert "diamondfill ")) :help "Sorry. There is no help for diamondfill "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["disk" (lambda () (interactive) (insert "disk ")) :help "Sorry. There is no help for disk "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["disks" (lambda () (interactive) (insert "disks ")) :help "Sorry. There is no help for disks "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["disks" (lambda () (interactive) (insert "disks ")) :help "Sorry. There is no help for disks "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["display" (lambda () (interactive) (insert "display ")) :help "Sorry. There is no help for display "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["dotfill" (lambda () (interactive) (insert "dotfill ")) :help "Sorry. There is no help for dotfill "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["drag" (lambda () (interactive) (insert "drag ")) :help "Sorry. There is no help for drag "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["ellipse" (lambda () (interactive) (insert "ellipse ")) :help "Sorry. There is no help for ellipse "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["erase" (lambda () (interactive) (insert "erase ")) :help "Sorry. There is no help for erase "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["fcircle" (lambda () (interactive) (insert "fcircle ")) :help "Sorry. There is no help for fcircle "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["fcircles" (lambda () (interactive) (insert "fcircles ")) :help "Sorry. There is no help for fcircles "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["fill" (lambda () (interactive) (insert "fill ")) :help "Sorry. There is no help for fill "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["fillcolor" (lambda () (interactive) (insert "fillcolor ")) :help "Sorry. There is no help for fillcolor "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["filled" (lambda () (interactive) (insert "filled ")) :help "Sorry. There is no help for filled "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["filltoborder" (lambda () (interactive) (insert "filltoborder ")) :help "Sorry. There is no help for filltoborder "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["floodfill" (lambda () (interactive) (insert "floodfill ")) :help "Sorry. There is no help for floodfill "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["fontcolor" (lambda () (interactive) (insert "fontcolor ")) :help "Sorry. There is no help for fontcolor "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["fontfamily" (lambda () (interactive) (insert "fontfamily ")) :help "Sorry. There is no help for fontfamily "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["fontsize" (lambda () (interactive) (insert "fontsize ")) :help "Sorry. There is no help for fontsize "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["fpoly" (lambda () (interactive) (insert "fpoly ")) :help "Sorry. There is no help for fpoly "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["frect" (lambda () (interactive) (insert "frect ")) :help "Sorry. There is no help for frect "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["frects" (lambda () (interactive) (insert "frects ")) :help "Sorry. There is no help for frects "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["froundrect" (lambda () (interactive) (insert "froundrect ")) :help "Sorry. There is no help for froundrect "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["froundrects" (lambda () (interactive) (insert "froundrects ")) :help "Sorry. There is no help for froundrects "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["fsquare" (lambda () (interactive) (insert "fsquare ")) :help "Sorry. There is no help for fsquare "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["ftriangle" (lambda () (interactive) (insert "ftriangle ")) :help "Sorry. There is no help for ftriangle "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["ftriangles" (lambda () (interactive) (insert "ftriangles ")) :help "Sorry. There is no help for ftriangles "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["functionlabel" (lambda () (interactive) (insert "functionlabel ")) :help "Sorry. There is no help for functionlabel "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["grid" (lambda () (interactive) (insert "grid ")) :help "Sorry. There is no help for grid "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["gridfill" (lambda () (interactive) (insert "gridfill ")) :help "Sorry. There is no help for gridfill "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["halfline" (lambda () (interactive) (insert "halfline ")) :help "Sorry. There is no help for halfline "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["halflines" (lambda () (interactive) (insert "halflines ")) :help "Sorry. There is no help for halflines "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["hatchfill" (lambda () (interactive) (insert "hatchfill ")) :help "Sorry. There is no help for hatchfill "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["highlight" (lambda () (interactive) (insert "highlight ")) :help "Sorry. There is no help for highlight "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["hline" (lambda () (interactive) (insert "hline ")) :help "Sorry. There is no help for hline "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["hlines" (lambda () (interactive) (insert "hlines ")) :help "Sorry. There is no help for hlines "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["horizontalline" (lambda () (interactive) (insert "horizontalline ")) :help "Sorry. There is no help for horizontalline "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["horizontallines" (lambda () (interactive) (insert "horizontallines ")) :help "Sorry. There is no help for horizontallines "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["html" (lambda () (interactive) (insert "html ")) :help "Sorry. There is no help for html "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["http" (lambda () (interactive) (insert "http ")) :help "Sorry. There is no help for http "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["imagefill" (lambda () (interactive) (insert "imagefill ")) :help "Sorry. There is no help for imagefill "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["input" (lambda () (interactive) (insert "input ")) :help "Sorry. There is no help for input "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["inputstyle" (lambda () (interactive) (insert "inputstyle ")) :help "Sorry. There is no help for inputstyle "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["intooltip" (lambda () (interactive) (insert "intooltip ")) :help "Sorry. There is no help for intooltip "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["jscurve" (lambda () (interactive) (insert "jscurve ")) :help "Sorry. There is no help for jscurve "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["jsmath" (lambda () (interactive) (insert "jsmath ")) :help "Sorry. There is no help for jsmath "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["jsplot" (lambda () (interactive) (insert "jsplot ")) :help "Sorry. There is no help for jsplot "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["killaffine" (lambda () (interactive) (insert "killaffine ")) :help "Sorry. There is no help for killaffine "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["killrotate" (lambda () (interactive) (insert "killrotate ")) :help "Sorry. There is no help for killrotate "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["killslider" (lambda () (interactive) (insert "killslider ")) :help "Sorry. There is no help for killslider "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["killtranslate" (lambda () (interactive) (insert "killtranslate ")) :help "Sorry. There is no help for killtranslate "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["killtranslation" (lambda () (interactive) (insert "killtranslation ")) :help "Sorry. There is no help for killtranslation "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["lattice" (lambda () (interactive) (insert "lattice ")) :help "Sorry. There is no help for lattice "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["legend" (lambda () (interactive) (insert "legend ")) :help "Sorry. There is no help for legend "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["legendcolors" (lambda () (interactive) (insert "legendcolors ")) :help "Sorry. There is no help for legendcolors "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["levelcurve" (lambda () (interactive) (insert "levelcurve ")) :help "Sorry. There is no help for levelcurve "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["line" (lambda () (interactive) (insert "line ")) :help "Sorry. There is no help for line "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["linegraph" (lambda () (interactive) (insert "linegraph ")) :help "Sorry. There is no help for linegraph "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["lines" (lambda () (interactive) (insert "lines ")) :help "Sorry. There is no help for lines "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["linewidth" (lambda () (interactive) (insert "linewidth ")) :help "Sorry. There is no help for linewidth "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["mathml" (lambda () (interactive) (insert "mathml ")) :help "Sorry. There is no help for mathml "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["mouse" (lambda () (interactive) (insert "mouse ")) :help "Sorry. There is no help for mouse "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["mouse_degree" (lambda () (interactive) (insert "mouse_degree ")) :help "Sorry. There is no help for mouse_degree "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["mousex" (lambda () (interactive) (insert "mousex ")) :help "Sorry. There is no help for mousex "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["mousey" (lambda () (interactive) (insert "mousey ")) :help "Sorry. There is no help for mousey "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["multidash" (lambda () (interactive) (insert "multidash ")) :help "Sorry. There is no help for multidash "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["multidraw" (lambda () (interactive) (insert "multidraw ")) :help "Sorry. There is no help for multidraw "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["multifill" (lambda () (interactive) (insert "multifill ")) :help "Sorry. There is no help for multifill "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["multifillcolors" (lambda () (interactive) (insert "multifillcolors ")) :help "Sorry. There is no help for multifillcolors "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["multifillopacity" (lambda () (interactive) (insert "multifillopacity ")) :help "Sorry. There is no help for multifillopacity "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["multilabel" (lambda () (interactive) (insert "multilabel ")) :help "Sorry. There is no help for multilabel "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["multilinewidth" (lambda () (interactive) (insert "multilinewidth ")) :help "Sorry. There is no help for multilinewidth "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["multisnaptogrid" (lambda () (interactive) (insert "multisnaptogrid ")) :help "Sorry. There is no help for multisnaptogrid "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["multistrokecolors" (lambda () (interactive) (insert "multistrokecolors ")) :help "Sorry. There is no help for multistrokecolors "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["multistrokeopacity" (lambda () (interactive) (insert "multistrokeopacity ")) :help "Sorry. There is no help for multistrokeopacity "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["multiuserinput" (lambda () (interactive) (insert "multiuserinput ")) :help "Sorry. There is no help for multiuserinput "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["noaxis" (lambda () (interactive) (insert "noaxis ")) :help "Sorry. There is no help for noaxis "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["noayis" (lambda () (interactive) (insert "noayis ")) :help "Sorry. There is no help for noayis "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["note" (lambda () (interactive) (insert "note ")) :help "Sorry. There is no help for note "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["onclick" (lambda () (interactive) (insert "onclick ")) :help "Sorry. There is no help for onclick "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["opacity" (lambda () (interactive) (insert "opacity ")) :help "Sorry. There is no help for opacity "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["parallel" (lambda () (interactive) (insert "parallel ")) :help "Sorry. There is no help for parallel "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["piechart" (lambda () (interactive) (insert "piechart ")) :help "Sorry. There is no help for piechart "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["pixels" (lambda () (interactive) (insert "pixels ")) :help "Sorry. There is no help for pixels "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["pixelsize" (lambda () (interactive) (insert "pixelsize ")) :help "Sorry. There is no help for pixelsize "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["plotsteps" (lambda () (interactive) (insert "plotsteps ")) :help "Sorry. There is no help for plotsteps "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["point" (lambda () (interactive) (insert "point ")) :help "Sorry. There is no help for point "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["pointer" (lambda () (interactive) (insert "pointer ")) :help "Sorry. There is no help for pointer "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["points" (lambda () (interactive) (insert "points ")) :help "Sorry. There is no help for points "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["poly" (lambda () (interactive) (insert "poly ")) :help "Sorry. There is no help for poly "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["polyline" (lambda () (interactive) (insert "polyline ")) :help "Sorry. There is no help for polyline "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["popup" (lambda () (interactive) (insert "popup ")) :help "Sorry. There is no help for popup "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["precision" (lambda () (interactive) (insert "precision ")) :help "Sorry. There is no help for precision "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["protractor" (lambda () (interactive) (insert "protractor ")) :help "Sorry. There is no help for protractor "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["ranget" (lambda () (interactive) (insert "ranget ")) :help "Sorry. There is no help for ranget "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["rangex" (lambda () (interactive) (insert "rangex ")) :help "Sorry. There is no help for rangex "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["rangey" (lambda () (interactive) (insert "rangey ")) :help "Sorry. There is no help for rangey "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["rays" (lambda () (interactive) (insert "rays ")) :help "Sorry. There is no help for rays "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["rect" (lambda () (interactive) (insert "rect ")) :help "Sorry. There is no help for rect "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["rects" (lambda () (interactive) (insert "rects ")) :help "Sorry. There is no help for rects "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["replyformat" (lambda () (interactive) (insert "replyformat ")) :help "Sorry. There is no help for replyformat "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["rotate" (lambda () (interactive) (insert "rotate ")) :help "Sorry. There is no help for rotate "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["rotationcenter" (lambda () (interactive) (insert "rotationcenter ")) :help "Sorry. There is no help for rotationcenter "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["roundrect" (lambda () (interactive) (insert "roundrect ")) :help "Sorry. There is no help for roundrect "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["roundrects" (lambda () (interactive) (insert "roundrects ")) :help "Sorry. There is no help for roundrects "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["ruler" (lambda () (interactive) (insert "ruler ")) :help "Sorry. There is no help for ruler "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["seg" (lambda () (interactive) (insert "seg ")) :help "Sorry. There is no help for seg "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["segment" (lambda () (interactive) (insert "segment ")) :help "Sorry. There is no help for segment "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["segments" (lambda () (interactive) (insert "segments ")) :help "Sorry. There is no help for segments "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["segs" (lambda () (interactive) (insert "segs ")) :help "Sorry. There is no help for segs "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["setlimits" (lambda () (interactive) (insert "setlimits ")) :help "Sorry. There is no help for setlimits "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["setpixel" (lambda () (interactive) (insert "setpixel ")) :help "Sorry. There is no help for setpixel "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["sgraph" (lambda () (interactive) (insert "sgraph ")) :help "Sorry. There is no help for sgraph "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["size" (lambda () (interactive) (insert "size ")) :help "Sorry. There is no help for size "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["slider" (lambda () (interactive) (insert "slider ")) :help "Sorry. There is no help for slider "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["sliderfunction_x" (lambda () (interactive) (insert "sliderfunction_x ")) :help "Sorry. There is no help for sliderfunction_x "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["sliderfunction_y" (lambda () (interactive) (insert "sliderfunction_y ")) :help "Sorry. There is no help for sliderfunction_y "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["snaptofun" (lambda () (interactive) (insert "snaptofun ")) :help "Sorry. There is no help for snaptofun "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["snaptofunction" (lambda () (interactive) (insert "snaptofunction ")) :help "Sorry. There is no help for snaptofunction "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["snaptogrid" (lambda () (interactive) (insert "snaptogrid ")) :help "Sorry. There is no help for snaptogrid "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["snaptopoints" (lambda () (interactive) (insert "snaptopoints ")) :help "Sorry. There is no help for snaptopoints "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["square" (lambda () (interactive) (insert "square ")) :help "Sorry. There is no help for square "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["status" (lambda () (interactive) (insert "status ")) :help "Sorry. There is no help for status "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["string" (lambda () (interactive) (insert "string ")) :help "Sorry. There is no help for string "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["stringup" (lambda () (interactive) (insert "stringup ")) :help "Sorry. There is no help for stringup "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["strokecolor" (lambda () (interactive) (insert "strokecolor ")) :help "Sorry. There is no help for strokecolor "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["text" (lambda () (interactive) (insert "text ")) :help "Sorry. There is no help for text "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["textarea" (lambda () (interactive) (insert "textarea ")) :help "Sorry. There is no help for textarea "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["textup" (lambda () (interactive) (insert "textup ")) :help "Sorry. There is no help for textup "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["trace_jscurve" (lambda () (interactive) (insert "trace_jscurve ")) :help "Sorry. There is no help for trace_jscurve "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["trange" (lambda () (interactive) (insert "trange ")) :help "Sorry. There is no help for trange "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["translate" (lambda () (interactive) (insert "translate ")) :help "Sorry. There is no help for translate "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["translation" (lambda () (interactive) (insert "translation ")) :help "Sorry. There is no help for translation "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["transparent" (lambda () (interactive) (insert "transparent ")) :help "Sorry. There is no help for transparent "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["triangle" (lambda () (interactive) (insert "triangle ")) :help "Sorry. There is no help for triangle "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["triangles" (lambda () (interactive) (insert "triangles ")) :help "Sorry. There is no help for triangles "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["userboxplot" (lambda () (interactive) (insert "userboxplot ")) :help "Sorry. There is no help for userboxplot "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["userboxplotdata" (lambda () (interactive) (insert "userboxplotdata ")) :help "Sorry. There is no help for userboxplotdata "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["userdraw" (lambda () (interactive) (insert "userdraw ")) :help "Sorry. There is no help for userdraw "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["userinput" (lambda () (interactive) (insert "userinput ")) :help "Sorry. There is no help for userinput "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["userinput_function" (lambda () (interactive) (insert "userinput_function ")) :help "Sorry. There is no help for userinput_function "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["userinput_textarea" (lambda () (interactive) (insert "userinput_textarea ")) :help "Sorry. There is no help for userinput_textarea "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["userinput_xy" (lambda () (interactive) (insert "userinput_xy ")) :help "Sorry. There is no help for userinput_xy "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["usertextarea_xy" (lambda () (interactive) (insert "usertextarea_xy ")) :help "Sorry. There is no help for usertextarea_xy "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["vector" (lambda () (interactive) (insert "vector ")) :help "Sorry. There is no help for vector "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["vectors" (lambda () (interactive) (insert "vectors ")) :help "Sorry. There is no help for vectors "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["verticalline" (lambda () (interactive) (insert "verticalline ")) :help "Sorry. There is no help for verticalline "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["verticallines" (lambda () (interactive) (insert "verticallines ")) :help "Sorry. There is no help for verticallines "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["video" (lambda () (interactive) (insert "video ")) :help "Sorry. There is no help for video "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["vline" (lambda () (interactive) (insert "vline ")) :help "Sorry. There is no help for vline "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["vlines" (lambda () (interactive) (insert "vlines ")) :help "Sorry. There is no help for vlines "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["xaxis" (lambda () (interactive) (insert "xaxis ")) :help "Sorry. There is no help for xaxis "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["xaxistext" (lambda () (interactive) (insert "xaxistext ")) :help "Sorry. There is no help for xaxistext "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["xaxistextup" (lambda () (interactive) (insert "xaxistextup ")) :help "Sorry. There is no help for xaxistextup "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["xaxisup" (lambda () (interactive) (insert "xaxisup ")) :help "Sorry. There is no help for xaxisup "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["xerrorbars" (lambda () (interactive) (insert "xerrorbars ")) :help "Sorry. There is no help for xerrorbars "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["xlabel" (lambda () (interactive) (insert "xlabel ")) :help "Sorry. There is no help for xlabel "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["xlogbase" (lambda () (interactive) (insert "xlogbase ")) :help "Sorry. There is no help for xlogbase "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["xlogscale" (lambda () (interactive) (insert "xlogscale ")) :help "Sorry. There is no help for xlogscale "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["xrange" (lambda () (interactive) (insert "xrange ")) :help "Sorry. There is no help for xrange "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["xsnaptogrid" (lambda () (interactive) (insert "xsnaptogrid ")) :help "Sorry. There is no help for xsnaptogrid "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["xunit" (lambda () (interactive) (insert "xunit ")) :help "Sorry. There is no help for xunit "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["xylogscale" (lambda () (interactive) (insert "xylogscale ")) :help "Sorry. There is no help for xylogscale "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["yaxis" (lambda () (interactive) (insert "yaxis ")) :help "Sorry. There is no help for yaxis "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["yerrorbars" (lambda () (interactive) (insert "yerrorbars ")) :help "Sorry. There is no help for yerrorbars "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["ylabel" (lambda () (interactive) (insert "ylabel ")) :help "Sorry. There is no help for ylabel "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["ylogbase" (lambda () (interactive) (insert "ylogbase ")) :help "Sorry. There is no help for ylogbase "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["ylogscale" (lambda () (interactive) (insert "ylogscale ")) :help "Sorry. There is no help for ylogscale "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["yrange" (lambda () (interactive) (insert "yrange ")) :help "Sorry. There is no help for yrange "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["ysnaptogrid" (lambda () (interactive) (insert "ysnaptogrid ")) :help "Sorry. There is no help for ysnaptogrid "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["yunit" (lambda () (interactive) (insert "yunit ")) :help "Sorry. There is no help for yunit "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw")["zoom" (lambda () (interactive) (insert "zoom ")) :help "Sorry. There is no help for zoom "])
