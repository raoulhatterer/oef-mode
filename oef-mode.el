...
(easy-menu-add-item oef-menu-bar '("Canvasdraw" "C")["circles" (lambda () (interactive) (insert "circles ")) :help "Sorry. There is no help for circles "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw" "C")["clearbutton" (lambda () (interactive) (insert "clearbutton ")) :help "Sorry. There is no help for clearbutton "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw" "C")["clock" (lambda () (interactive) (insert "clock ")) :help "Sorry. There is no help for clock "])
(easy-menu-add-item oef-menu-bar '("Canvasdraw" "C")["copy" (lambda () (interactive) (insert "copy ")) :help "Sorry. There is no help for copy "])
