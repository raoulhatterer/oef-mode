...
;(easy-menu-add-item oef-menu-bar '("Canvasdraw")["\\canvasdraw" (lambda () (interactive) (insert "\\canvasdraw{«width»,«height»}{\\my_draw} ")) :help "First define a text variable (i.e. \\my_draw) containing the drawing code"]) 
