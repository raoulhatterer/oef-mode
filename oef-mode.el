...
;; Version: "20231014.0413"
;; previous Version: "20231014.0228"
...
(defconst oef-mode-version "20231014.0413"
...
(easy-menu-define oef-menu-bar oef-mode-map "OEF-mode menu"
  '("OEF" ; we start by creating a menu that is initially empty. This menu will be called "OEF" in the menu-bar.
    ...
    ["Rainbow Colors (toogle)" rainbow-mode t]
...
(define-derived-mode oef-mode sgml-mode
  ...
  (define-key oef-mode-map (kbd "C-o r") 'rainbow-mode) ;    
  ...
  (font-lock-add-keywords
   ...
   `(
     ...
     ("\\(^\\\\statement{\\)\\([^z-a]*\\)\\(} \\)[\n]" (1 'oef-font-statement-command-face)(2 'oef-font-statement-face)(3 'oef-font-statement-command-face)) ; command statement just one line         
